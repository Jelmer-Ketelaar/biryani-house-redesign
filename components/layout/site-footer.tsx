...
export function SiteFooter() {
  return (
    <footer className="border-t border-white/10 bg-[#080605] text-[#f8e6c8]/70">
      <div className="container grid gap-8 py-10 text-sm md:grid-cols-[1.2fr_0.8fr_0.8fr]">
        <div className="max-w-sm">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            {["Halal kitchen", "Secure checkout", "Fresh daily"].map((label) => (
              <span
                key={label}
                className="inline-flex items-center gap-1 rounded-full border border-[#d99a2b]/24 bg-[#d99a2b]/10 px-3 py-1 text-xs font-bold text-[#f2c46e]"
              >
        ...
        <div>
          ...
          <div className="mt-3 space-y-2">
            ...
            <p className="flex items-center gap-2">
              <MapPin className="h-4 w-4 text-[#d99a2b]" /> {restaurant.address}
            </p>
            <p className="flex items-center gap-2">
              <Sparkles className="h-4 w-4 text-[#d99a2b]" /> Buffet, takeaway, delivery, and catering
              ready
            </p>
            <p className="flex items-center gap-2">
              <Phone className="h-4 w-4 text-[#d99a2b]" /> {restaurant.phoneDisplay}
            </p>
            <p className="flex items-center gap-2">
              <Mail className="h-4 w-4 text-[#d99a2b]" /> {restaurant.email}
            </p>
            <p className="flex items-center gap-2">
              <Mail className="h-4 w-4 text-[#d99a2b]" /> Catering/business:{" "}
